...
import com.anooc.android.md.presenter.contract.IMainPresenter;
import com.anooc.android.md.presenter.implement.MainPresenter;

import com.anooc.android.md.presenter.contract.IMdPresenter;
import com.anooc.android.md.ui.adapter.TopicListAdapter;
import com.anooc.android.md.ui.base.FullLayoutActivity;
...
import com.anooc.android.md.ui.listener.NavigationOpenClickListener;
...
import com.anooc.android.md.ui.view.IMainView;
                ...
                if (navItem.isChecked()) {
                    switch (navItem.getId()) {
                        ...
                        case R.id.btn_nav_job:
                            tab = TabType.job;
                            break;
                        case R.id.btn_nav_cloud_note:
                            tab = TabType.cloud_notes;
                            break;
                        default:
