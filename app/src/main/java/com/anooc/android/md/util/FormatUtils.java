package com.anooc.android.md.util;
...
public final class FormatUtils {
    ...
    public static boolean isMdLinkUrl(@Nullable String url) {
        return !TextUtils.isEmpty(url) && url.startsWith(ApiDefine.Md_LINK_URL_PREFIX);
    }
